...
for g in S:
    ...
    for edge in current_flow_betweeness2.keys():
        final_current_flow_betweeness2[edge] = current_flow_betweeness2[edge]
...
for edge in exp.nx_graph[t].edges:
    ...
    if edge not in final_current_flow_betweeness2.keys() and (edge[1], edge[0]) not in final_current_flow_betweeness2.keys():
        final_current_flow_betweeness2[edge] = 0
nx.set_edge_attributes(exp.nx_graph[t], final_current_flow_betweeness, "current_flow_betweenness")
nx.set_edge_attributes(exp.nx_graph[t], final_current_flow_betweeness2, "current_flow_betweenness2")
