...
from sthype.hypergraph.hypergraph_from_spatial_graphs import (
...
plates = ["441_20230807", "449_20230807", "310_20230830"]
...
for plate_id in plates:
    ...
    spatial_temporal_graph = spatial_temporal_graph_from_spatial_graphs(
        spatial_graphs, np.arange(len(spatial_graphs)), verbose=1
    )
