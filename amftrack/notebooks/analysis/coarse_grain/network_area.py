...
imageio.mimsave(f'/home/cbisot/pycode/MscThesis/amftrack/notebooks/plotting/Figure/movie_dense_{kern_size}_{plate_number}thresh.gif', img_array,duration = 1)
sizes = []
for index,density_map in enumerate(density_maps):
    im= density_map[kern_size][0]
