...
# Load an image
img = plt.imread(r"C:\Users\coren\AMOLF-SHIMIZU Dropbox\Corentin Bisot\temp\Img_r09_c07.png")
...
def onclick(event):
    ...
    selected_rectangle = Rectangle((selected_point[0] - 0.5, selected_point[1] - 0.5), 1, 1, fill=True, color='red')
